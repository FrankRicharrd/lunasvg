...
{
    d->color = to_bl_color(color);
    d->type = StyleType::Color;
}
...
void lunasvg::Canvas::clear(unsigned int value)
{
...
void Canvas::clear(unsigned int r, unsigned int g, unsigned int b, unsigned int a)
{
    /*auto r = (value >> 24) & 0xFF;
    auto g = (value >> 16) & 0xFF;
    auto b = (value >> 8) & 0xFF;
